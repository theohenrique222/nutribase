    ...
    <section id="hero" class="bg-[url('background.jpg')] lg:bg-cover bg-center bg-no-repeat w-full">
        <main class="flex flex-col-reverse lg:flex-row w-full px-2 sm:px-3 lg:max-w-6xl md:max-w-3xl sm:max-w-xl max-w-xs m-auto">
            ...
            <div class="flex flex-col w-full m-auto lg:h-screen mt-24 lg:text-end">
                ...
                <div class="flex flex-col lg:flex-row items-center justify-center lg:justify-end space-y-8 lg:space-y-0 lg:space-x-10 mb-10 mt-6">
                    <a href="/" class="text-white hover:text-lime-400">
                        www.nutribase.com.br
                    </a>
                    <a href="/" class="bg-lime-400 text-neutral-700 hover:bg-neutral-100 py-3 px-10 rounded-sm uppercase font-bold">
                        Assine Já
                    </a>
                </div>
            </div>
