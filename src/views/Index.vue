<template>
  ...
  <section class="bg-[url('background-2.jpg')] bg-cover w-full lg:h-screen">
    <main class="flex flex-col lg:flex-row w-full px-2 sm:px-3 lg:max-w-6xl md:max-w-3xl sm:max-w-xl max-w-xs m-auto">
  ...
  <section class="bg-[url('background3.jpg')] bg-cover w-full lg:h-screen min-h-screen">
    <main class="flex flex-col-reverse lg:flex-row w-full px-2 sm:px-3 lg:max-w-6xl md:max-w-3xl sm:max-w-xl max-w-xs m-auto lg:my-0 my-10 space-x-10">
